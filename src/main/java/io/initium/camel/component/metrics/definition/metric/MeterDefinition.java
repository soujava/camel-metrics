 ...
 * @since 2014-04-17
 */
public class MeterDefinition extends ExpressionMetricDefinition {

	// constants
	private static final String	DEFAULT_NAME_BASE		= "meter";
	...
	public String toString() {
		...
		builder.append("MeterDefinition [value=");
